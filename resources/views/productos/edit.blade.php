...
@section('content')
    <div class="container py-5">
        <h2 class="h2 mb-4">Editar producto</h2>
                    ...
                    <form action="{{ route('admin.productos.update', $producto->id) }}" method="POST" autocomplete="off">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="precio" id="precio" class="form-control @error('precio') is-invalid @enderror" value="{{ old('precio', $producto->precio) }}" step="0.01" min="0" required>
                                @error('precio')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-3">
                                <label for="stock" class="form-label color-destacado">Stock <span class="text-danger">*</span></label>
                                <input type="number" name="stock" id="stock" class="form-control @error('stock') is-invalid @enderror" value="{{ old('stock', $producto->stock) }}" min="0" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="fecha_reposicion" id="fecha_reposicion" class="form-control @error('fecha_reposicion') is-invalid @enderror" value="{{ old('fecha_reposicion', $producto->fecha_reposicion ? \Carbon\Carbon::parse($producto->fecha_reposicion)->format('Y-m-d') : '') }}">
                                @error('fecha_reposicion')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-12">
